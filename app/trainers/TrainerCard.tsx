    ...
    <article className="overflow-hidden rounded-2xl border border-gray-200 bg-white shadow-sm">
      ...
      <div className="p-4">
        ...
        <div className="mt-4 flex items-center gap-3">
          <button
            className="inline-flex w-full items-center justify-center gap-2 rounded-full border border-gray-300 bg-white px-4 py-2 text-sm hover:bg-gray-50"
            onClick={() => onPreview?.(t)}
          >
          ...
          <button
            className="inline-flex w-full items-center justify-center gap-2 rounded-full bg-rose-500 px-4 py-2 text-sm font-medium text-white hover:bg-rose-600"
