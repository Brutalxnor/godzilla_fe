...
import { GetUserById } from "../services/Auth.service"; // غير المسار لو مختلف
import useGetUser from "../Hooks/useGetUser"; // لو الـ hook ده global
  ...
  const fetchUsers = async () => {
    try {
      ...
      const formattedUsers: LiteUser[] = result.data
        ...
        .filter((user: Li) => user.id !== userDB?.data?.user_id)
