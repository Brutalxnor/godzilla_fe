...
const Chat = () => {
  ...
  const currentMessages = selectedUser ? chats[selectedUser.id] || [] : [];
  const [sender_id, setSenderId] = useState<number>();
    ...
    const channel = supabase
      ...
      .on("broadcast", { event: "new-message" }, (payload) => {
        ...
        setChats((prev) => {
          ...
          setSenderId(newMessage.sender_id as number);
        ...
        <div className="flex-1 flex overflow-hidden">
          ...
          {view === "chat" && (
            <section
              ...
              "
            >
              <div className="bg-gray-600 w-96 absolute bottom-2 h-20 rounded-xl right-2">
                <h1>Mosha</h1>
              </div>
