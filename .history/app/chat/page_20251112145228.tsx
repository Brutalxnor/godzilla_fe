...
const Chat = () => {
  ...
  return (
                      ...
                      >
                        <div className="relative shrink-0">
                          <div className="relative shrink-0">
                            ...
                            {/* Online Dot */}
                            <span className="absolute bottom-0 right-0 h-3 w-3 rounded-full border-2 border-white dark:border-zinc-900 bg-emerald-500">
                              {/* لو حابب ممكن تستخدم component */}
                              {/* <OnlineDot online={user.status === "online"} /> */}
                            </span>
                          </div>
    ...
    "
                >
                  <div className="grid h-10 w-10 place-items-center rounded-full bg-rose-500 text-white text-sm font-semibold">
